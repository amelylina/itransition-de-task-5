...
def compute_all_anomalies(series: pd.Series, params: AnomalyParams)-> dict[str, pd.Series]:
    results = {}
...
def render_mine_tab(
    ...
    effective_type = "Bar" if chart_type == "Stacked" else chart_type
    fig = build_chart(name, series, effective_type, anomalies, trendline_degree)
...
def render_total_tab(
    ...
    if chart_type == "Stacked":
        fig = build_stacked_chart(df, mines, trendline_degree, anomalies)
    else:
